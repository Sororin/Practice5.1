...
This is an interactive map with some tourist spots in Taiwan (I personally recommend). 

You can click on these marks for more information about the tourist spot (with website link and address)

Please note: These marks are slightly away from the real location on map due to the projective problem of the world map.

```{r map, message=F, warning=F, evel=F}
library(leaflet)
library(rgdal)
